    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0">Thêm mới khách hàng</h3>
                </div>
                <div class="col-sm-6">
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="row g-4">
                <div class="col-12">
                    <div class="card mb-4">
                        <form class="needs-validation" id="customerCreateForm" method="POST" 
                              action="{{ route('admin.customers.store') }}" novalidate>
                            @csrf
                            <div class="card-body">
                                <div class="row g-3">
                                    <!-- Name -->
                            ...
                            <div class="card-footer">
                                <button class="btn btn-success btn-sm" type="submit">Lưu khách hàng</button>
                            </div>
                        </form>
                    </div>
                </div>
