        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.exports.index') }}">Phiếu nhập</a></li>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                @php $total = 0; @endphp
                                @foreach($purchase->exports as $item)
                                    @php
                        ...
                        <a href="{{ route('admin.exports.index') }}" class="btn btn-secondary btn-sm mt-3">Quay lại</a>
                    </div>
                </div>
            </div>
        </div>
