...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center my-2">
                <div class="col-sm-6">
                    <h3 class="mb-0">Cập nhật nhà cung cấp</h3>
                </div>
                <div class="col-sm-6">
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="row g-4">
                <div class="col-12">
                    <form class="needs-validation" id="supplierEditForm" method="POST" action="{{ route('admin.suppliers.update', $supplier->id) }}" novalidate>
                        @csrf
                        @method('PUT')
