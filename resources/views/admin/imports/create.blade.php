    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center my-2">
                <div class="col-sm-6">
                    <h3 class="mb-0">Thêm mới phiếu nhập hàng</h3>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 position-relative DropdownInput">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="supplier-search" name="supplier_search" placeholder="Tìm nhà cung cấp..." autocomplete="off">
                                        
                                        <select class="form-select form-select-sm mt-1 position-absolute DropdownInputSelect" id="supplier-select" size="5">
                                            <!-- JS sẽ bind data vào đây -->
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="import_date" id="import-date" class="form-control form-control-sm" value="{{ old('import_date', date('Y-m-d')) }}">
                                    </div>
